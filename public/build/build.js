...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _MainTemplate = __webpack_require__(7);
	...
	// register a filter
	_vue2.default.filter('authorIdToName', function (id, authors) {

		var author = authors.length > 0 ? authors.find(function (a) {
			return id === a.id;
		}) : '';

		if (author.hasOwnProperty('name')) return author.name;else return '';
	});

	// expose the whole thing on element with 'app' as an id
	router.start(_MainTemplate2.default, '#app');
